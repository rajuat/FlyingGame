package com.andriod.myapplication.draw;
...
/**
 * Created by raju.athokpam on 28-07-2016.
 */
public class PathRendererView extends View {
    ...
    public PathRendererView(Context context, AttributeSet attrs)
    {
        ...
        fillBMP = BitmapFactory.decodeResource(context.getResources(), R.drawable.grassbg1);
        //Initialize the BitmapShader with the Bitmap object and set the texture tile mode
        fillBMPshader = new BitmapShader(fillBMP, Shader.TileMode.CLAMP, Shader.TileMode.MIRROR);
